...
const footerData = {
    ...
    socialMedia: [
        { icon: fbIcon, name: 'Facebook', href: "https://www.facebook.com/sprwforge" },
        { icon: inIcon, name: 'LinkedIn', href: "https://www.linkedin.com/company/sparrow-forge-ltd/posts/?feedView=all" },
        // { icon: twIcon, name: 'Twitter (X)', href: "#" },
        // { icon: instraIcon, name: 'Instagram', href: "#" },
        { icon: wpIcon, name: 'WhatsApp', href: "https://wa.me/8801339314661" },
    ],
    contact: [
        {
            icon: gmailIcon,

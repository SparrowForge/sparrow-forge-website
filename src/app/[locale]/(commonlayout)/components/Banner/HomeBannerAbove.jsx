...
const HomeBannerAbove = () => {
    ...
    return (
        <div className="flex flex-col justify-start items-start py-6 md:py-10 px-4 md:px-0 md:gap-4">
            {/* Achievements Banner */}
            ...
            <div className="hidden md:flex flex-col">
                {/* Main Heading */}
                <h1 className="text-xl md:text-[60px] text-white font-bold text-start">
                    {t(LOCALE_KEYS.BUILD_YOUR)} <br />
                    <span className="text-yellow-500">{t(LOCALE_KEYS.DREAM_PRODUCT)}</span> <br />
            ...
            <div className=" flex md:hidden flex-col mb-5 gap-2">
                {/* Main Heading */}
                <h1 className="text-2xl md:text-[60px] text-white font-bold text-start">
                    {t(LOCALE_KEYS.BUILD_YOUR)} {" "}
                    <span className="text-yellow-500">{t(LOCALE_KEYS.DREAM_PRODUCT)}</span> {" "}
                    {t(LOCALE_KEYS.FASTER_DELIVERY)}
                </h1>
